    ...
    <div  class="c-new-body">
      <div>
        ...
        <el-table class="c-table" :data="tableData" v-loading="loading" element-loading-text="加载中..." highlight-current-row ref="multipleTable" style="width: 100%">
          ...
          <el-table-column label="楼栋名称1" min-width="100" align="left" :show-overflow-tooltip="true">
            <template slot-scope="scope">{{ scope.row.name}}</template>
          </el-table-column>
          <el-table-column label="楼面层数1" min-width="60" align="left" :show-overflow-tooltip="true">
            <template slot-scope="scope">{{ scope.row.overGround}}</template>
          </el-table-column>
          <el-table-column label="地下层数1" min-width="60" align="left" :show-overflow-tooltip="true">
            <template slot-scope="scope">{{0 - scope.row.underGround}}</template>
          </el-table-column>
          <el-table-column label="总层数1" min-width="60" align="left" :show-overflow-tooltip="true">
