              ...
              <ul class="c-three">
                <li class="c-three-li">
                  ...
                  <div class="c-three-detail">
                    <div>
                      <p class="c-color-white c-fs-24 c-tl-center">{{ alarmData.unReviewedNum }}</p>
                      <span class="c-color-white ">待审核</span>
                    </div>
                    <div>
                      <p class="c-color-white c-fs-24 c-tl-center">{{ alarmData.reviewedNum }}</p>
                ...
                <li class="c-three-li">
                  ...
                  <div class="c-three-detail">
                    <div>
                      <p class="c-color-white c-fs-24 c-tl-center">{{ alarmData.unPaymentNum }}</p>
                      <span class="c-color-white ">待缴费</span>
                    </div>
                    <div>
                      <p class="c-color-white c-fs-24 c-tl-center">{{ alarmData.overdueNum }}</p>
                ...
                <li class="c-three-li">
                  ...
                  <div class="c-three-detail">
                    <div>
                      <p class="c-color-white c-fs-24 c-tl-center">{{ alarmData.unCheckedNum }}</p>
                      <span class="c-color-white ">待处理</span>
                    </div>
                    <div>
                      <p class="c-color-white c-fs-24 c-tl-center">{{ alarmData.receivedNum }}</p>
...
export default {
  ...
  methods:{
    getUser() {
      this.$xttp.get(`/user/property/${this.communityId}/user-list`)
        .then(res => {
          if(!res.errorCode) {
    ...
    getTask(bool) {
      this.$xttp.post(`/property/gtasks/queryGtasksPage`,{communityId:this.communityId})
        .then(res => {
          if(!res.errorCode) {
    ...
    getAlarm() {//获取数据
      this.$xttp.get(`/statistics/manager/${this.communityId}/todo`)
        .then(res => {
          if(!res.errorCode) {
      ...
      .c-three {
        ...
        .c-three-li {
          ...
          .c-three-title {
            ...
            margin: 0 auto;
            color:#ffffff;
            border-bottom: .6px solid #ccd6d8;
          }
          .c-three-detail {
            width:100%;
            margin-top:20px;
