  ...
  <el-main>
    <div>
      ...
      <div class="c-search">
        ...
        <el-button type="success" plain class="c-addBtn" @click="onSubmit" v-if="pms['11S2']">新增商户</el-button>
      </div>
    </div>
    ...
    <el-table class="c-table" :data="tableData" v-loading="loading" element-loading-text="加载中..." border
      ...
      <el-table-column label="详细地址" min-width="200" align="left" :show-overflow-tooltip="true">
